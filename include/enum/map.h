...
{
    LEVEL_00_NULL                    = 0x00,
    LEVEL_0D_CUTSCENE_OR_SYSTEM      = 0x0D,
    LEVEL_0F_GGM_GLITTER_GULCH_MINE  = 0x0F,
    LEVEL_10_MT_MAYAHEM_TEMPLE       = 0x10,
    LEVEL_12_WW_WITCHYWORLD          = 0x12,
    LEVEL_13_SM_SPIRAL_MOUNTAIN      = 0x13,
    LEVEL_14_JRL_JOLLY_ROGERS_LAGOON = 0x14,
    LEVEL_15_TDL_TERRYDACTYLAND      = 0x15,
    LEVEL_16_GI_GRUNTY_INDUSTRIES    = 0x16,
    LEVEL_17_HFP_HAILFIRE_PEAKS      = 0x17,
    LEVEL_18_CCL_CLOUD_CUCKOOLAND    = 0x18,
    LEVEL_19_CK_CAULDRON_KEEP        = 0x19,
    LEVEL_1A_IoH_ISLE_OF_HAGS        = 0x1A,
    LEVEL_1B_MULTIPLAYER             = 0x1B
} LEVEL;
...
typedef enum MAP
{
    ...
    /* 0x00B0 >>> */ MAP_0B0_CRASH,
    /* 0x00B1 >>> */ MAP_0B1_CRASH,
    /* 0x00B2 >>> */ MAP_0B2_CRASH,
    /* 0x00B3 >>> */ MAP_0B3_CRASH,
    /* 0x00B4 >>> */ MAP_0B4_CRASH,
    /* 0x00B5 >>> */ MAP_0B5_CRASH,
    ...
    /* 0x00BD >>> */ MAP_0BD_CRASH,
    /* 0x00BE >>> */ MAP_0BE_CRASH,
    /* 0x00BF >>> */ MAP_0BF_CRASH,
    /* 0x00C0 >>> */ MAP_0C0_CRASH,
    /* 0x00C1 >>> */ MAP_0C1_CRASH,
    /* 0x00C2 >>> */ MAP_0C2_CRASH,
    /* 0x00C3 >>> */ MAP_0C3_CRASH,
    ...
    /* 0x00F0 >>> */ MAP_0F0_CRASH,
    /* 0x00F1 */ MAP_0F1_JRL_INSIDE_THE_UFO,
    /* 0x00F2 >>> */ MAP_0F2_UNKNOWN,
    /* 0x00F3 >>> */ MAP_0F3_CRASH,
    /* 0x00F4 */ MAP_0F4_JRL_ANCIENT_SWIMMING_BATHS,
    /* 0x00F5 >>> */ MAP_0F5_CRASH,
    ...
    /* 0x00FB >>> */ MAP_0FB_CRASH,
    /* 0x00FC */ MAP_0FC_JRL_BOSS_LORD_WOO_FAK_FAK,
    /* 0x00FD >>> */ MAP_0FD_CRASH,
    /* 0x00FE >>> */ MAP_0FE_CRASH,
    ...
    /* 0x011C >>> */ MAP_11C_CRASH,
    /* 0x011D >>> */ MAP_11D_CRASH,
    ...
    /* 0x016B >>> */ MAP_16B_CRASH,
    /* 0x016C >>> */ MAP_16C_CRASH,
    /* 0x016D >>> */ MAP_16D_CRASH,
    /* 0x016E >>> */ MAP_16E_CRASH,
    ...
    /* 0x0174 >>> */ MAP_174_CRASH,
    /* 0x0175 >>> */ MAP_175_CRASH,
    ...
    /* 0x0184 >>> */ MAP_184_CRASH_UNUSED_PIPE,
    ...
    /* 0x019E >>> */ MAP_19E_CRASH,
    /* 0x019F >>> */ MAP_19F_CRASH,
    /* 0x01A0 >>> */ MAP_1A0_UNKNOWN,
    /* 0x01A1 >>> */ MAP_1A1_UNKNOWN,
    /* 0x01A2 >>> */ MAP_1A2_UNKNOWN,
    /* 0x01A3 >>> */ MAP_1A3_UNKNOWN,
    /* 0x01A4 >>> */ MAP_1A4_UNKNOWN,
    /* 0x01A5 >>> */ MAP_1A5_UNKNOWN,
